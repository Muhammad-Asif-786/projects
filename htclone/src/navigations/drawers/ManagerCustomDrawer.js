...
const ManagerCustomDrawer = (props) => {
  ...
  const menu = [
    { name: "ManagerDashboard", label: "Dashboard", icon: "home" },
    ...
    { name: "DepositExemption", label: "Deposit Exemption", icon: "shield" },
    { name: "DepositMultiplierOverride", label: "Deposit Multiplier Override", icon: "percent" },
    { name: "GoodsReceivedVerification", label: "Goods Received Verification", icon: "truck" },
    { name: "CompletedAuctions", label: "Completed Auctions", icon: "video" },
  ];
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          <Image
            ...
            style={styles.logo}
          />
          <Text style={styles.title}>HT Manager</Text>
        </View>
