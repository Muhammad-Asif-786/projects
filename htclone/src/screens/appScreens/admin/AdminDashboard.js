...
const auctionsData = [
  { id: '1', title: 'Auto Motive', code: 'EVT-2026-002', status: 'LIVE', lots: 2, start: 'Jan 13', end: 'Jun 16', image: require('../../../assets/kia.jpg') },
    ...
    <View style={styles.container}>
      ...
      <View style={styles.tabs}>
        ...
        <View style={styles.tabsLeft}>
          ...
          <TouchableOpacity onPress={() => { setTab('all'); setPage(1); }}
...
const styles = StyleSheet.create({
  ...
  button: {
    backgroundColor: 'rgb(38, 193, 108)',
    paddingVertical: 10,
